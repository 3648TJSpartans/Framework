package frc.robot.framework.io.out.sensor.SensorTypes.Accelerometers;

import org.w3c.dom.Element;

import frc.robot.framework.io.out.sensor.SensorTypes.Accelerometers.ACLTypes.ADXL_345_I2C;
import frc.robot.framework.io.out.sensor.SensorTypes.Accelerometers.ACLTypes.ADXL_345_SPI;
import frc.robot.framework.io.out.sensor.SensorTypes.Accelerometers.ACLTypes.ADXL_362;
import frc.robot.framework.io.out.sensor.SensorTypes.Accelerometers.ACLTypes.Analog_Accelerometer;
import frc.robot.framework.io.out.sensor.SensorTypes.Accelerometers.ACLTypes.Built_In_Accelerometer;
